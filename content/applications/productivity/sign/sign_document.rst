...
- a document or :ref:`document envelope <sign/prepare-document/create-envelope>` that you or another
  person :ref:`prepared for electronic signature using Odoo Sign
  <sign/sign-document/signature-request>`; or
- a `.pdf` document or documents that have :ref:`not been prepared for electronic signature
...
- **internal user**, the first time you use Odoo Sign to complete an :guilabel:`Initial` or
  ...
  your intials/signature are stored for future use.
...
document saved in that folder to be signed without having to leave the Documents app.
