...
::
   ...
   └── src
       ...
       │       └── 000.xml
       └── builder
           ├── s_snippet_name_option.js
           └── s_snippet_name_option.xml
...
.. code-block:: javascript
   :caption: ``/website_airproof/static/src/builder/airproof_snippet_option.js``

   class AirproofSnippetOptionPlugin extends Plugin {
...
object. They are added to the `builder-plugins` registry category (or `website-plugins` for
website-only extensions). Plugins can also declare dependencies and shared APIs, and run
initialization logic in `setup()`.
...
Binding relies on CSS selectors (class, tag, ID, etc.) to decide when an option appears.
...
Option components declare selector metadata that controls when they appear.
...
.. image:: building_blocks/builder_row.png
...
.. image:: building_blocks/builder_button.png
...
.. image:: building_blocks/builder_select.png
...
.. image:: building_blocks/builder_button_group.png
...
.. image:: building_blocks/builder_checkbox.png
...
Each step of the range maps to one entry in the `actionParam` array.

.. image:: building_blocks/builder_range.png
...
.. image:: building_blocks/builder_number_input.png
...
.. image:: building_blocks/builder_colorpicker.png
